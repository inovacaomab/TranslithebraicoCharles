(() => {
  ...
  var holemWaw = (word, options) => {
    ...
    const vowels2 = /[\u{05B0}-\u{05BB}\u{05C7}]/u;
    const vavHolemMale = new RegExp("(?<!" + vowels2.source + ")" + wawHolemRegX.source, "gu");
    const vavHolemHaser = new RegExp("(?<=" + vowels2.source + ")" + wawRegX.source + taamim.source + "?" + holemRegx.source, "gu");
  ...
  var Cluster = class _Cluster extends Node {
    ...
    get vowels() {
      ...
      const vowels2 = this.chars.reduce((a, char) => {
        const text = char.text;
      ...
      return __classPrivateFieldSet2(this, _Cluster_vowelsCache, vowels2, "f");
    }
  };
  ...
  var Syllable = class _Syllable extends Node {
    ...
    get vowels() {
      ...
      const vowels2 = noTaamim.replace(shureq, shureqPresentation).split("").reduce((a, v) => {
      ...
      return __classPrivateFieldSet3(this, _Syllable_vowelsCache, vowels2, "f");
    }
    /**
  ...
  var getDageshChazaqVal = (input, dagesh2, isChazaq) => {
    if (!isChazaq) {
      return input;
    }
  ...
  var joinSyllableChars = (syl, sylChars, schema) => {
    ...
    if (schema.STRESS_MARKER) {
      ...
      const vowelRgx = new RegExp(`${vowels2.join("|")}`);
