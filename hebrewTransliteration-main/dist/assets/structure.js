(() => {
  ...
  var Syllable = class _Syllable extends Node {
    ...
    structure(withGemination = false) {
      ...
      if (heClusters.length === 0) {
        const structure3 = ["", "", ""];
        __classPrivateFieldSet3(this, _Syllable_cachedStructure, structure3, "f");
        __classPrivateFieldSet3(this, _Syllable_cachedStructureWithGemination, structure3, "f");
        return structure3;
      }
      ...
      if (this.isFinal && !this.isClosed) {
        ...
        if (matchFurtive) {
          const structure3 = ["", matchFurtive[2], matchFurtive[1] + (matchFurtive[3] || "")];
          __classPrivateFieldSet3(this, _Syllable_cachedStructure, structure3, "f");
          __classPrivateFieldSet3(this, _Syllable_cachedStructureWithGemination, structure3, "f");
          return structure3;
        }
      ...
      const structure2 = [onset, nucleus, coda];
      if (withGemination) {
  ...
  // src/assets/js/structure.js
  feedbackFormInit();
  var defaultOpts = {
    "0591": "\\n",
    "05C3": "\\n"
  };
  var loadOptions = (options, defaultOpts2) => {
    options.forEach((o) => {
      const v = localStorage.getItem(o.key) ?? defaultOpts2[o.key] ?? null;
      const input2 = document.querySelector(`[id='${o.key}']`);
      if (v && input2) {
        input2.value = v;
      } else input2.value = "";
    });
  ...
  var structure = async (text, options) => {
    try {
  ...
  var steps = document.querySelector("#modal-cards").children;
  var nextBtn = document.querySelector("#next-btn");
  var prevBtn = document.querySelector("#prev-btn");
  var finalBtn = document.querySelector("#final-btn");
